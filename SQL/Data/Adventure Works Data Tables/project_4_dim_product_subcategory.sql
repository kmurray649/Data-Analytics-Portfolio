CREATE TABLE dim_product_subcategory (
    ...
    english_product_subcategory_name varchar(100),
    spanish_product_subcategory_name varchar(100),
    french_product_subcategory_name varchar(100),
    product_category_key int,
    PRIMARY KEY(record_id)
);

INSERT INTO dim_product_subcategory(product_subcategory_key, product_subcategory_alternate_key, english_product_subcategory_name, spanish_product_subcategory_name, 
